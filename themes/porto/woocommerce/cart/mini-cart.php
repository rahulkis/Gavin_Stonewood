...
<?php
	if ( empty( $porto_settings['minicart-content'] ) ) {
		...
		echo '<div class="total-count text-v-dark fdfdfdfdf">';
...
<ul class="cart_list product_list_widget fdfdfdfdf scrollbar-inner <?php echo esc_attr( $args['list_class'] ); ?>">
	<?php if ( $has_items ) : ?>
	...
	//echo '';?>
		...
		<li class="woocommerce-mini-cart__empty-message empty fdfdfdfdf">
			<?php
