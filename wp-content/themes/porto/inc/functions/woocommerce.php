	...
	function porto_woocommerce_add_to_cart_notification_html() {
		...
		<?php if ( 2 === (int) $porto_settings['add-to-cart-notification'] ) : ?>
			...
			<div class="loader success-message-container">
			    ...
			    <a class="button btn-primay viewcart" href="<?php echo wc_get_page_permalink( 'cart' );?>"><?php esc_html_e( 'View Cart', 'porto' ); ?></a>
				<a class="button btn-primay continue_shopping" href="<?php echo esc_url( function_exists( 'wc_get_checkout_url' ) ? wc_get_checkout_url() : wc_get_page_permalink( 'checkout' ) ); ?>"><?php esc_html_e( 'View Checkout', 'porto' ); ?></a>
			</div>
		<?php else : ?>
			...
			<a class="btn btn-modern btn-sm btn-gray viewcart btn-sm" href="<?php echo wc_get_page_permalink( 'cart' );?>"><?php esc_html_e( 'View Cart', 'porto' ); ?></button>
