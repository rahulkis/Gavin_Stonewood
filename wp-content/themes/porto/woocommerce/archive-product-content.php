...
?>
<!--<div class="feaured_products">
<h2 style="text-align: center;margin-top: -20px;">Popular Products</h2>
<?php //echo do_shortcode('[featured_products per_page="6" columns="3" orderby="date" order="DESC"]');?>
</div>-->

<div class="feaured_products">
<h2 style="text-align: center;margin-top: -20px;">What our customers say</h2>
<?php echo do_shortcode('[sp_testimonial id="3174"]');?>
</div>
<?php
	/**
