...
if (!class_exists('ElfsightCookieConsentPlugin')) {
    class ElfsightCookieConsentPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightCookieConsentPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightCookieConsentWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightCookieConsentPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightCookieConsentWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightCookieConsentVCElement($config, $this->widgetsApi);
