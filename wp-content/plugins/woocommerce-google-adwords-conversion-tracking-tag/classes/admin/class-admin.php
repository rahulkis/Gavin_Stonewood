...
class Admin
{
    ...
    public function add_section_advanced_subsection_google( $section_ids )
    {
        ...
        if ( wpm_fs()->can_use_premium_code__premium_only() || $this->pro_version_demo_active() ) {
            ...
            add_settings_field(
                ...
                [ $this, 'pmw_setting_html_g4_page_load_time_tracking' ],
                'wpm_plugin_options_page',
                $section_ids['settings_name']
            );
        }
        ...
        if ( wpm_fs()->can_use_premium_code__premium_only() || $this->pro_version_demo_active() ) {
            ...
            add_settings_field(
                ...
                [ $this, 'pmw_setting_html_google_optimize_anti_flicker_snippet_timeout' ],
                'wpm_plugin_options_page',
                $section_ids['settings_name']
            );
        }
    ...
    public function pmw_setting_html_g4_page_load_time_tracking()
    {
        // adding the hidden input is a hack to make WordPress save the option with the value zero,
        // instead of not saving it and remove that array key entirely
        // https://stackoverflow.com/a/1992745/4688612
		...
		<?php 
        $this->get_status_icon( $this->options['google']['analytics']['ga4']['page_load_time_tracking'], true, true );
    ...
    public function pmw_setting_html_google_optimize_anti_flicker_snippet()
    {
		...
		<?php 
        $this->get_status_icon( Options::get_options_obj()->google->optimize->anti_flicker, Options::is_google_optimize_active(), true );
        $this->html_pro_feature();
    ...
    public function pmw_setting_html_google_optimize_anti_flicker_snippet_timeout()
    {
        ?>
		<input class="pmw mono"
		...
		/>
		<?php 
        $this->get_status_icon( $this->options['google']['optimize']['anti_flicker'], true, true );
    ...
    public function html_lazy_load_pmw()
    {
		...
		<?php 
        $this->get_status_icon( $this->options['general']['lazy_load_pmw'], Options::lazy_load_requirements(), true );
        ?>
		<?php 
