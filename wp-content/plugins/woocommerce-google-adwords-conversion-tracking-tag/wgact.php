 ...
 *
 **/
const  PMW_CURRENT_VERSION = '1.30.6' ;
    ...
    class WCPM
    {
        ...
        public function __construct()
        {
            ...
            if ( $this->are_requirements_met() ) {
                ...
                if ( get_option( PMW_DB_OPTIONS_NAME ) ) {
        ...
        private function wpm_options_init()
        {
            ...
            $this->options = get_option( PMW_DB_OPTIONS_NAME );
            ...
            update_option( PMW_DB_OPTIONS_NAME, $this->options );
        }
