		...
		<tbody>
			<tr>
				...
				<td>
					...
					<input type="checkbox" id="kpso_wp_rocket_support" name="kpso_wp_rocket_support" <?php if($kpso_wp_rocket_support == "yes") { echo "checked"; } ?> value="<?php if($kpso_wp_rocket_support == "yes") { echo "yes"; } else { echo "no"; } ?>"><label for="kpso_wp_rocket_support">Execute delayed JS of <b>WP Rocket (3.12.6.1)</b></label>
					<br>
				</td>
			</tr>
			<tr>
